...
<LINK href="${pageContext.request.contextPath}/resource/admin/css/Style.css"
	type="text/css" rel="stylesheet">
<script language="javascript"
	src="${pageContext.request.contextPath}/resource/admin/js/public.js"></script>
<script language="javascript"
	src="${pageContext.request.contextPath}/resource/admin/js/check.js"></script>
