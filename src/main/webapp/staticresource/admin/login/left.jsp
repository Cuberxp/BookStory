...
<title>菜单</title>
<link href="${pageContext.request.contextPath}/resource/admin/css/left.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<div class="dtree">
	...
	<link rel="StyleSheet" href="${pageContext.request.contextPath}/resource/admin/css/dtree.css" type="text/css" />
	<script type="text/javascript" src="${pageContext.request.contextPath}/resource/admin/js/dtree.js"></script>
