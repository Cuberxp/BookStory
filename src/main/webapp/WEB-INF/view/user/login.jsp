							...
							<tr>
										...
										<table width="100%" border="0" cellspacing="0">
											<tr>
												<td style="text-align:center; padding-top:20px">
													<img src="${pageContext.request.contextPath}/staticresource/images/logintitle.gif" width="150" height="30" />
												</td>
											</tr>
											<tr>
												<td style="text-align:center;padding-top:20px;">
													<font color="#ff0000">${requestScope["login_err"]}</font>
												</td>
											</tr>
											<tr>
												<td style="text-align:center">
													<table width="80%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td style="text-align:left"><input id="username" name="username"
																	<c:if test="${cookie.rememberMe.value == 'YES'}">
																		value="${cookie.reusername.value}"
																	</c:if>
														...
														<tr>
															...
															<td style="text-align:left"><input id="password" name="password"
														...
														<tr>
															<td colspan="2"
																style="padding-top:10px; text-align:center"><input
																	...
																	src="${pageContext.request.contextPath}/staticresource/images/loginbutton.gif" width="83" height="22" />
															</td>
														</tr>

														<tr>
															<td colspan="2" style="padding-top:10px"><img
																	src="${pageContext.request.contextPath}/staticresource/images/loginline.gif" width="241" height="10" />
															</td>
														</tr>
														<tr>
															<td colspan="2"
																style="padding-top:10px; text-align:center"><a
																	href="register"><img name="image" src="${pageContext.request.contextPath}/staticresource/images/signupbutton.gif" width="135" height="33" />
															</a></td>
														</tr>
													</table>
												</td>
								...
								<td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
									...
									<p style="text-align:right">
										<a href="register"><img src="${pageContext.request.contextPath}/staticresource/images/signupbutton.gif" width="135" height="33" /> </a>
									</p>
								</td>
							</tr>
						</table>
